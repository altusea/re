...
public class PisanoPeriod {
    ...
    public static long multiply(long a, long b, long modulus) {
    ...
    private static final Map<Long, Map<Long, Long>> allFactors = new TreeMap<>();
    ...
    public static Map<Long, Long> getFactors(Long number) {
